...
<input type="hidden" id="doctor_id" name="doctor_id" class="form-control" value="<?php echo !empty($doctor_id) ? $doctor_id : ''; ?>">
    <div class="col-sm-3">
...
<div class="col-sm-9">
<p class="text-muted mb-0"><?php //echo !empty($user_email) ? $user_email : '-'; ?></p>
</div>
</div>
<hr>
<div class="row">
...
<div class="col-sm-9">
<p class="text-muted mb-0"><?php //echo !empty($user_phone) ? $user_phone : '-'; ?></p>
</div>
</div>
<hr>
<div class="row">
...
<div class="col-sm-9">
<p class="text-muted mb-0"><?php //echo ( !empty( $user_status ) && $user_status == 1 ) ? 'Active' : 'In-Active'; ?></p>
</div>
</div>
-->
